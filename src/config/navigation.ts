...
export const navigationItems: NavigationItem[] = [
  ...
  { label: "任务管理", href: "/tasks", icon: CheckSquare2, available: true, roles: ["department_head", "employee"] },
  { label: "组织人事", href: "/people", icon: UsersRound, available: true, roles: ["hr", "executive", "department_head"] },
  { label: "考勤管理", href: "/attendance", icon: CalendarCheck2, available: true, roles: ["hr", "department_head", "employee", "finance"] },
