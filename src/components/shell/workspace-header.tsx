          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className={demo.enabled ? "w-80" : "w-52"}>
              ...
              <DropdownMenuGroup>
                ...
                {workspaceActor.role === "department_head" ? <><DropdownMenuItem asChild><Link href="/people"><UsersRound aria-hidden="true" />我的团队</Link></DropdownMenuItem><DropdownMenuItem asChild><Link href="/payroll"><Settings aria-hidden="true" />我的工资单</Link></DropdownMenuItem><DropdownMenuItem asChild><Link href="/leave"><UserRound aria-hidden="true" />请假与审批</Link></DropdownMenuItem></> : null}
