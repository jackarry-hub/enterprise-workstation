...
const roleSteps: Record<WorkspaceRole, readonly string[]> = {
  ...
  department_head: ["在负责人推进台承接部门目标", "检查 AI 分配人员，协调阻塞和跨部门支持", "验收员工成果并填写明确意见", "处理团队任务与协同请求"],
  employee: ["在我的执行台查看已解锁任务", "开始任务、更新进度，遇到问题立即上报阻塞", "上传真实成果文件并提交验收", "查看任务反馈与已授权的个人信息"],
  finance: ["在财务执行中心处理预算协同", "等待服务器核对前置条件", "执行薪资核算和最终发放", "保留财务结果并回流发起任务"],
  hr: ["在人事协同中心处理人员与培训请求", "处理已授权的人事协同请求", "完成人员与薪资复核", "维护组织档案和审批记录"],
};
