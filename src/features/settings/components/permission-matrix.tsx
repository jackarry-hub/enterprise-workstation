...
export function PermissionMatrix() {
  ...
  const groups = session.permissionCodes.reduce<Record<string, string[]>>((result, permission) => { const module = permission.split(".")[0]; result[module] = [...(result[module] ?? []), permission]; return result; }, {});
