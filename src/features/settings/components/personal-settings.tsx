...
export function PersonalSettings({ value, onChange, onAvatarSelect }: { value: SettingsState["profile"]; onChange: (value: SettingsState["profile"]) => void; onAvatarSelect: (file: File) => void }) {
