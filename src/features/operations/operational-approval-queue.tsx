...
export function OperationalApprovalQueue() {
  ...
  const entries = [
    ...(capabilities.approvals ? [{ href: "/approvals", label: "财务审批", detail: `${financePending} 项待办理`, icon: Banknote }] : []),
    ...(capabilities.people ? [{ href: "/people", label: "人事协同", detail: `${hrPending} 项待办理`, icon: UsersRound }] : []),
  ];
